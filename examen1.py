...
class App(customtkinter.CTk):
    ...
    def btn_agregar_on_click(self):
        tipo_de_marca = prompt("Marca: " , "Marca")
        tipo_de_auto = prompt("tipo de auto: ", " tipo de Auto")
        kms_del_auto = int(prompt("kms: ", "kilometros del auto"))
        if kms_del_auto > 0:
            self.lista_kms_vehiculos.append(kms_del_auto)
            self.lista_marca_vehiculo.append(tipo_de_marca)
            self.lista_tipo_vehiculo.append(tipo_de_auto)
    ...
    def btn_mostrar_on_click(self):
        i = 0
        while i < len(self.lista_kms_vehiculos):
            print(str(i)  +  "tipo de vehiculo: " + self.lista_tipo_vehiculo[i] +  "Marca" +self.lista_marca_vehiculo[i] + "kilometraje " + str(self.lista_kms_vehiculos[i]) )
            i = i +1
